...
export default function Dashboard() {
  ...
  const handleGenerateGraph = () => {
    ...
    if (chartType === "Pie" || chartType === "Donut") {
      ...
      formattedData = Object.keys(sums).map((name) => ({
        name,
        value: sums[name],
      }));
    } else {
    ...
    <div className="flex flex-col min-h-screen bg-[#0d1117] text-[#c9d1d9] p-8 font-sans">
      ...
      <div className="w-full max-w-xl mx-auto space-y-6 bg-[#161b22] border border-[#30363d] p-8 rounded-xl shadow-lg">
        ...
        <div className="flex flex-col items-center">
          <label
            htmlFor="file-upload"
            className="cursor-pointer bg-[#0370a7] text-white py-3 px-6 rounded-md hover:bg-[#2083ba]"
          >
            Choose a File
          </label>
          <input
          ...
          {selectedFile && (
            <button
              ...
              className="mt-4 bg-[#238636] text-white py-2 px-4 rounded-md hover:bg-[#2ea043]"
            >
              Upload to Server
            </button>
          )}
        ...
        {columns.length > 0 && (
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full bg-[#238636] text-white py-3 rounded-md hover:bg-[#2ea043]"
            >
              Generate Graph
            </button>
          </div>
        ...
        {message && (
          <div className="p-3 text-center text-green-400 border border-green-500 rounded">
            {message}
          </div>
        )}
      </div>
